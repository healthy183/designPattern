 ...
 */
@Slf4j
public class JimDisplay implements Observer,DisplayElement {

    private float temp;
    private float humidity;
    private float pressure;

    public JimDisplay(WeatherDateSubject weatherDateSubject){
        weatherDateSubject.registerObserver(this);
    }

    @Override
    public void display() {
        log.info("this is jim,temp:[{}],humidity:[{}]",temp,humidity);
    }
